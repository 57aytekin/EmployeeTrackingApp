package com.example.employeetrackingapp.other

import android.annotation.SuppressLint
import android.content.Context
import android.content.SharedPreferences
import android.preference.PreferenceManager
import com.example.employeetrackingapp.ui.employee_tracking.EmployeeTrackingFragment.Companion.DAY_TIMESTAMP
import com.example.employeetrackingapp.ui.employee_tracking.EmployeeTrackingFragment.Companion.LAST_INDEX
import com.example.employeetrackingapp.ui.employee_tracking.EmployeeTrackingFragment.Companion.LIST_ID
...
class PrefUtils {
    ...
    fun getLastSavedIndex(): Int {
        return preferences.getInt(LAST_INDEX, 0)
    }
    fun getId(): Int {
        return preferences.getInt(LIST_ID, 0)
    }
    fun getCurrentDay(): Long {
        return preferences.getLong(DAY_TIMESTAMP, System.currentTimeMillis())
    }
